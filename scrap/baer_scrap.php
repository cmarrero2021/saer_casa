...
$m=1;
$conn = pg_connect("host=localhost port=5432 dbname=scv user=postgres password=VentuAri-03") or die("NO SE PUDO ESTABLECER LA CONEXION");
...
for ($x=0;$x<$filas;$x++) {
	...
	if ($cedula !="") {
		$nombre_archivo = "baer_capital.sql"; 
		...
		if($archivo = fopen($nombre_archivo, "a")) {
			...
			$insertar =pg_query($conn,$mensaje);
			echo "N° $m ============================================"."<br/>";
			echo $cedula."<br/>";
			echo $nombre."<br/>";
			echo $estado."<br/>";
